        ...
        <form method="POST" action="{{ route('members.update', $member->member_id) }}" class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200">
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <option value="youth" {{ old('membership_category', $member->membership_category) === 'youth' ? 'selected' : '' }}>Youth</option>
                                <option value="child" {{ old('membership_category', $member->membership_category) === 'child' ? 'selected' : '' }}>Child</option>
                                <option value="university-student" {{ old('membership_category', $member->membership_category) === 'university-student' ? 'selected' : '' }}>University Student</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <option value="not-baptized" {{ old('baptism_status', $member->baptism_status) === 'not-baptized' ? 'selected' : '' }}>Not Baptized</option>
                                <option value="pending" {{ old('baptism_status', $member->baptism_status) === 'pending' ? 'selected' : '' }}>Pending</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            <label for="membership_status" class="text-sm font-medium">Membership Status <span class="text-red-500">*</span></label>
                            <select
                            ...
                            >
                                ...
                                <option value="archived" {{ old('membership_status', $member->membership_status) === 'archived' ? 'selected' : '' }}>Archived</option>
                            </select>
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                @foreach($sabbathClasses as $class)
                                    <option value="{{ $class->id }}" {{ old('sabbath_school_class_id', $member->sabbath_school_class_id) == $class->id ? 'selected' : '' }}>
                                        {{ $class->name }}
                                    </option>
                                @endforeach
                            </select>
