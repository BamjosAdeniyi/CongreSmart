<x-app-layout>
    <div class="space-y-4 md:space-y-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h1 class="text-xl md:text-2xl text-gray-900">Sabbath School Reports</h1>
                <p class="text-sm md:text-base text-gray-500">Attendance and performance reports</p>
            </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach($reports as $report)
                                    <tr class="hover:bg-gray-50">
                                        <td class="py-4 px-4">
                                            <div>
                                                <div class="font-medium text-gray-900">{{ $report['class']->name }}</div>
                                                <div class="text-sm text-gray-600">{{ $report['class']->meeting_day }} {{ $report['class']->meeting_time }}</div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-4">
                                        ...
                                        <td class="py-4 px-4 text-center">
                                            <span class="font-medium">{{ $report['average_attendance'] }}</span>
                                        </td>
                                        <td class="py-4 px-4 text-center">
                                        ...
                                        <td class="py-4 px-4 text-center">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                @if($report['attendance_rate'] >= 80) bg-green-100 text-green-800
                                                @elseif($report['attendance_rate'] >= 60) bg-yellow-100 text-yellow-800
                                        ...
                                        <td class="py-4 px-4 text-center">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                @if($report['class']->active) bg-green-100 text-green-800
