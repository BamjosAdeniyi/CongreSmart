<x-app-layout>
    <div class="space-y-4 md:space-y-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h1 class="text-xl md:text-2xl text-gray-900 dark:text-gray-100">Sabbath School</h1>
                <p class="text-sm md:text-base text-gray-500 dark:text-gray-400">Manage classes and track attendance</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($classes as $class)
                <div class="relative bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow">
                    @if(Auth::user()->role === 'superintendent')
                        <div class="absolute top-0 right-0 mr-3 mt-3">
                            <button
                                ...
                                class="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white transition"
                                title="Edit Class"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                class="p-2 rounded-lg bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/40 text-red-600 dark:text-red-400 transition"
                                title="Delete Class"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1 pr-8">
                            <div class="flex gap-2">
                                <h3 class="flex text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $class->name }}</h3>
                                @if(!$class->active)
                                    <span class="flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300">
                                        Inactive
                                    </span>
                                @endif
                            </div>
                            @if($class->description)
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ Str::limit($class->description, 60) }}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span class="dark:text-gray-300">{{ $class->coordinator?->first_name ?? 'N/A' }} {{ $class->coordinator?->last_name ?? '' }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span class="dark:text-gray-300">{{ $class->members_count }} members</span>
                        </div>
                    </div>

                    <div class="flex gap-2 mt-4">
                        <a href="{{ route('sabbath-school.show', $class) }}"
                           class="flex-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-2 rounded-lg text-sm font-medium text-center transition-colors">
                            View Details
                        </a>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Create Sabbath School Class</h2>
                    ...
                    <form method="POST" action="{{ route('sabbath-school.store') }}" class="space-y-6">
                        ...
                        <div>
                            <label for="modal_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Class Name *</label>
                            <input type="text" id="modal_name" name="name" value="{{ old('name') }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('name') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <textarea id="modal_description" name="description" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror"
                        ...
                        <div>
                            <label for="modal_coordinator_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Coordinator *</label>
                            <select id="modal_coordinator_id" name="coordinator_id"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('coordinator_id') border-red-500 @enderror" required>
                        ...
                        <div class="flex gap-3">
                            <button type="button" onclick="closeCreateModal()" class="flex-1 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg transition-colors">
                                Cancel
                            </button>
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Edit Sabbath School Class</h2>
                    ...
                    <form id="editForm" method="POST" class="space-y-6">
                        ...
                        <div>
                            <label for="edit_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Class Name *</label>
                        ...
                        <div>
                            <label for="edit_coordinator_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Coordinator *</label>
                        ...
                        <div class="flex gap-3">
                            <button type="button" onclick="closeEditModal()" class="flex-1 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg transition-colors">
                                Cancel
                            </button>
                            <button type="submit" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors">
                                Update Class
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full">
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-3">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Delete Class</h3>
                            <p id="deleteMessage" class="text-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete this class?</p>
                        </div>
                    </div>
