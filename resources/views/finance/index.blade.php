<x-app-layout>
    <div class="space-y-6">
        <div>
            <h1 class="text-xl md:text-2xl text-gray-900">Finance Management</h1>
            <p class="text-sm md:text-base text-gray-500">Manage contributions, categories, and financial reports</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ $contributionsUrl }}" class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold">Record Contributions</h3>
                        <p class="text-sm text-gray-500">Enter member contributions</p>
                    </div>
                </div>
            </a>

            <a href="{{ $categoriesUrl }}" class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold">Financial Categories</h3>
                        <p class="text-sm text-gray-500">Manage contribution types</p>
                    </div>
                </div>
            </a>

            <a href="{{ $reportsUrl }}" class="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">View income and expense reports</p>
                    </div>
                </div>
            </a>
        </div>
