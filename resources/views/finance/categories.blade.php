                        ...
                        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if($category->contributions_count == 0)
                                    <button onclick="confirmDelete('{{ $category->id }}', '{{ addslashes($category->name) }}')" class="text-red-600 hover:text-red-900 p-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-3">
                            ...
                            <p id="deleteMessage" class="text-sm text-gray-500">Are you sure you want to delete this category?</p>
                        </div>
                    </div>
